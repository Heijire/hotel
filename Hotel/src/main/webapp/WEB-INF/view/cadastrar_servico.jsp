						...
						<c:forEach var="servicoss" items="${servicoss}">
							<tr>
								...
								<td><a class="a_link_clicavel"
									href="${pageContext.request.contextPath}/cadastrar_servico?acao=editar&id=${servicoss.id}">Editar</a>
								</td>

								<td><a class="a_link_clicavel"
									href="${pageContext.request.contextPath }/cadastrar_servico?acao=excluir&id=${servicoss.id}">Deletar</a>
								</td>
							</tr>
						</c:forEach>
					</tbody>
