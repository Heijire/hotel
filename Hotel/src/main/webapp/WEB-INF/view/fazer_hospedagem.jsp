...
<body>
	...
	<div>
		...
		<ul class="nav nav-pills nav-fill">
			...
			<li class="nav-item"><a class="nav-link active"
				href="fazer_hospedagem">Realizar Hospedagem</a></li>
	...
	<div>
		...
		<br />
		<form action="consultar_disponiveis" method="get" class="mb-3">
						...
						<c:forEach var="hospedagens" items="${hospedagens}">
							<tr>
								...
								<td><a class="a_link_clicavel"
									href="${pageContext.request.contextPath}/fazer_hospedagem?acao=editar&id=${hospedagens.id}">Editar</a>
								</td>

								<td><a class="a_link_clicavel"
									href="${pageContext.request.contextPath }/fazer_hospedagem?acao=excluir&id=${hospedagens.id}">Deletar</a>
								</td>
